      ...
      <MobileDescription>
        <TippyContent>
          ...
          <p>
            ...
            out their social media instead!
          </p>
        </TippyContent>
        <TippyContent>
          <TippyHeader>Sign up</TippyHeader>
          <p>
            Sign up to ECS Empower through SUSU by clicking the button below!
          </p>
          <TippyButton
            href="https://www.susu.org/groups/ecs-empower"
            target="_blank"
        ...
        <TippyContent>
          ...
          <TippyPair>
            <Icon path={mdiAt} size={0.7} />
            <TippyHyperlink href="mailto:ecspower@soton.ac.uk" target="_blank">
              ecspower@soton.ac.uk
            </TippyHyperlink>
          </TippyPair>
          <TippyPair>
