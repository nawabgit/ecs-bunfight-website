    ...
    <CenteredPanel>
      ...
      <MobileDescription>
        <TippyContent>
          <TippyHeader>Sign up</TippyHeader>
          <p>
            Sign up to the ECSS FC Football Trials by clicking the button below!
          </p>
          <TippyButton
            href="https://forms.office.com/Pages/ResponsePage.aspx?id=-XhTSvQpPk2-iWadA62p2BJYKmItmY5FjJlYYOsVlaVURFNZTDNUSkswNURQWk40TFoyVlNZSzJTUSQlQCN0PWcu&fbclid=IwAR0qWPXC3-y0WnEURJOVHnC3RH9673sSlP89PY1gsmtq1hZMLVuBKoHErBw"
            target="_blank"
        ...
        <div style={{ padding: "0.5rem" }}>
          ...
          <SmallHeader>ECSS A</SmallHeader>
          <p>
            ECSS A (est. 2007) is a football team in the 2 nd division of the
            Intramural Sunday league. In the 2019/20 season, ECSS A won all 7
            games we played, all but guaranteeing us promotion into the top
            division. However, due to the Covid-19 outbreak, the season was
            declared null and void. Training consists of fitness, technical and
            tactical drills, followed by 6/7 a side game. Social events help the
            squad to bond, both with themselves and players in the B team. The
            squads are reviewed regularly throughout the season, with promotion
            to the A team possible for any club member. ECSS A is the perfect
            squad for anyone who has a background in football and is looking to
            improve alongside players of a similar mindset.
          </p>
          <SmallHeader>ECSS B</SmallHeader>
          <p>
            ECSS B (Est. 2018) is a football team in the 3 rd  division of the
            Intramural Sunday league. Over the past couple of seasons, the
            quality and numbers in the squad have been growing steadily and this
            year we are looking to be extremely competitive in the league with
            your help! Our training sessions focus on both some technical drills
            but mainly shape and movement for the 11-a-side games. We play
            because we love the game so whether you’ve been playing for years,
            or only have a little experience this is the club for you. ECSS B is
            the perfect squad for anyone who is new to the game and is looking
            to develop their skills and have a good time.
          </p>
          <SmallHeader>Tour</SmallHeader>
          <p>
            The annual ECSS FC Tour is undoubtedly the best thing you will
            experience in your university career. There is no better way to
            consolidate team chemistry than spending 5 days with the lads in a
            popular European city, consuming beverages, doing karaoke and
            beating the local engineering society at a friendly game of
            11-a-side. Tour secretary is elected at the AGM each year to
            organise the holiday.
          </p>
          <SmallHeader>Socials</SmallHeader>
          <p>
            Whether or not you’re making an impact on the football pitch socials
            are for every member of the club regardless of ability.  Socials aid
            in creating the true chemistry between players of both squads,
            through the consumption of a cold beverage (Either alcoholic or
            Non-Alcoholic depending on your preference) and a few laughs with
            the lads over some games or whatever the weeks theme demands. 
            Socials take place every other Wednesday and the theme of each
            social varies from week to week, the only recurring theme is the
            infamous Shirt and Ties you will become accustomed to and never want
            to take off and the games you will have to learn. A few examples of
            previous socials we have had are: 
            <ul>
              <li>Father Sons social </li>
              <li>Sausage social  </li>
              <li>Halloween Fitness social </li>
            ...
            Prior to the outbreak of COVID-19 we would journey to Oceana, a club
            which features Southampton’s main attraction - The Cheese floor.
            Where we would dance into the early hours of the morning and share
            tales to other students whilst consuming a slightly below room
            temperature sugar laced VK. However, the Great minds of the Backroom
            staff have been working hard to find a suitable alternative to
            provide a similar experience whilst complying with the current
